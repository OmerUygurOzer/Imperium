...
public class GameWorld implements Renderable, TimedUpdateable {
    ...
    public GameWorld(Resources resources, WorldSize worldSize) {
        worldResources = resources;
        entities = new Entity[(int)((worldSize.getRadius() * 2) * (worldSize.getRadius() * 2) / Tile.SIZE) * 6];
        ...
        map = new Map(resources, worldSize);
        addEntity(new Unit(this,resources.man,Layer.GROUND));
    }
